...
class CodeGenContext(
    ...
    data class Poet(
        ...
        val updateField = packageUtil.className("UpdateField")
        val updateFieldNullable = packageUtil.className("UpdateField", "Nullable")
        val updateFieldNotNullable = packageUtil.className("UpdateField", "NotNullable")
